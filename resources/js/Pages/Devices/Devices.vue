<template>
    <AppLayout :title="__('devices.routename')">
        ...
        <div class="py-2">
            <div class="flex flex-col gap-2 ml-2 mr-2 lg:flex-row">
                <div class="w-full lg:w-1/2">
                    <!-- left block -->
                    <div v-for="receiver in receivers" :key="receiver.id" class="mb-3 flex w-full transform cursor-pointer flex-col rounded-md bg-white bg-opacity-75 p-6 text-slate-800 transition duration-500 ease-in-out hover:-translate-y-1 hover:shadow-lg dark:bg-slate-700 dark:bg-opacity-25 dark:text-slate-300 lg:flex-row lg:p-4 mx-auto" style="background: rgba(0, 0, 0, 0.2);">
                                ...
                                <div class="flex w-full flex-col lg:flex-row lg:w-full">
                                    <div class="relative flex flex-row w-12">
                                        <div class="flex h-12 w-12 flex-shrink-0 flex-col justify-center rounded-full bg-slate-200 bg-opacity-50 dark:bg-slate-600">
                                            <img src="storage/images/odbiornik.png" class="z-10 h-12 w-12 rounded-full object-cover" alt="camera">

                                            <span v-if="receiver.status_id == 1" class="absolute right-0 top-0 z-20 flex h-3 w-3">
                                                <span class="absolute inline-flex h-full w-full animate-ping rounded-full bg-green-400 opacity-75"></span>
                                                <span class="relative inline-flex h-3 w-3 rounded-full bg-green-400"></span>
                                            </span>

                                            <span v-else-if="receiver.status_id == 2" class="absolute right-0 top-0 z-20 flex h-3 w-3">
                                                <span class="absolute inline-flex h-full w-full animate-ping rounded-full bg-red-400 opacity-75"></span>
                                                <span class="relative inline-flex h-3 w-3 rounded-full bg-red-400"></span>
                                            </span>

                                            <span v-else-if="receiver.status_id == 3" class="absolute right-0 top-0 z-20 flex h-3 w-3">
                                            ...
                                            <span v-else-if="receiver.status_id == 4" class="absolute right-0 top-0 z-20 flex h-3 w-3">
                                    ...
                                    <div class="relative flex flex-row">
                                        ...
                                        <div class="relative flex flex-col">
                                            <div class="h-10 overflow-y-hidden" :class="[receiver.wifistrength != null ? 'waveStrength-' + receiver.parsedstrength : 'waveStrength-0']">
                                                <div class="wv4 wave">
                                                    <div class="wv3 wave">
                                                        <div class="wv2 wave">
        ...
        receiver.localip : __('devices.panel.localiperror')
                                    ...
                                    <div class="w-full self-center text-end lg:w-1/2 lg:pt-0 relative lg:static mr-4">
                            ...
                            <div v-for="transmitter in receiver.get_transmitters" :key="transmitter.id">
                                <div class=" mb-3 mt-2 flex max-w-screen-xl transform cursor-pointer flex-col rounded-md bg-white bg-opacity-75 p-6 text-slate-800 transition duration-500 ease-in-out hover:-translate-y-1 hover:shadow-lg dark:bg-slate-700 dark:bg-opacity-25 dark:text-slate-300 lg:flex-row lg:p-4 mx-auto" style="background: rgba(0, 0, 0, 0.2);">
                                    <div class="flex w-full flex-row lg:w-full items-center justify-center">
                                        <div class="relative flex flex-col">
                                            <div class="flex h-12 w-12 flex-shrink-0 flex-col justify-center rounded-full bg-slate-200 bg-opacity-50 dark:bg-slate-600">
                                                <img src="storage/images/czujnik.png" class="z-10 h-12 w-12 rounded-full object-cover" alt="camera">

                                                <span v-if="transmitter.status_id == 1" class="absolute right-0 top-0 z-20 flex h-3 w-3">
                                                    <span class="absolute inline-flex h-full w-full animate-ping rounded-full bg-green-400 opacity-75"></span>
                                                    <span class="relative inline-flex h-3 w-3 rounded-full bg-green-400"></span>
                                                </span>

                                                <span v-else-if="transmitter.status_id == 2" class="absolute right-0 top-0 z-20 flex h-3 w-3">
                                                    <span class="absolute inline-flex h-full w-full animate-ping rounded-full bg-red-400 opacity-75"></span>
                                                    <span class="relative inline-flex h-3 w-3 rounded-full bg-red-400"></span>
                                                </span>

                                                <span v-else-if="transmitter.status_id == 3" class="absolute right-0 top-0 z-20 flex h-3 w-3">
                                                    <span class="absolute inline-flex h-full w-full animate-ping rounded-full bg-yellow-400 opacity-75"></span>
                                                    <span class="relative inline-flex h-3 w-3 rounded-full bg-yellow-400"></span>
                                                </span>

                                                <span v-else-if="transmitter.status_id == 4" class="absolute right-0 top-0 z-20 flex h-3 w-3">
                                                    <span class="absolute inline-flex h-full w-full rounded-full bg-gray-400 opacity-75"></span>
                                                    <span class="relative inline-flex h-3 w-3 rounded-full bg-gray-400"></span>
                                                </span>
                                            </div>
                                        ...
                                        <div class="w-1/2 lg:ml-4 ml-1 overflow-x-hidden hidden lg:block">
                                            <div class="w-full truncate text-xl font-extrabold leading-5 tracking-tight flex justify-center items-center">
                                                <div class="w-24">
                                                    <div class="shadow w-1/2 rounded border-2 border-white flex my-1 relative">
                                                        <div class="border-r-4 h-4 rounded-r absolute flex border-white ml-12 mt-1 z-10">
                                                        </div>
                                                        <div class="cursor-default text-xs font-bold leading-none flex items-center justify-center m-1 py-2 text-center text-white" :class="[transmitter.batterypercentage >= 50 ? 'bg-green-600' : 'bg-red-500']" :style="{ width: transmitter.batterypercentage + '%' }">
                                                ...
                                                <div class="flex -ml-8">{{ transmitter.batteryvoltage }} V</div>
                                            </div>
                                        </div>
                    ...
                    <div v-if="receivers.length" class="mb-1 flex w-full lg:w-1/2 max-w-screen-xl transform flex-col rounded-md bg-white bg-opacity-75 p-6 text-slate-800 transition duration-500 ease-in-out hover:-translate-y-1 hover:shadow-lg dark:bg-slate-700 dark:bg-opacity-25 dark:text-slate-300 lg:p-4" style="background: rgba(0,0,0,0.2);">
                ...
                <div v-if="cameras.length" class="w-full lg:w-1/2 mb-12">
                    <div v-for="camera in cameras" :key="camera.id" class="mb-3 flex max-w-screen-xl transform cursor-pointer  flex-col rounded-md bg-white bg-opacity-75 p-6 text-slate-800 transition duration-500 ease-in-out hover:-translate-y-1 hover:shadow-lg dark:bg-slate-700 dark:bg-opacity-25 dark:text-slate-300 lg:flex-row lg:p-4 mx-auto" style="background: rgba(0,0,0,0.2);">
                        <div class="flex w-full flex-row lg:w-full">
                            <div class="relative flex flex-col">
                                <div class="flex h-12 w-12 flex-shrink-0 flex-col justify-center rounded-full bg-slate-200 bg-opacity-50 dark:bg-slate-600">
                                    <img src="storage/images/camera.png" class="z-10 h-12 w-12 rounded-full object-cover" alt="camera">
                                    ...
                                    <span v-else-if="camera.status_id == 2" class="absolute right-0 top-0 z-20 flex h-3 w-3">
                                        <span class="absolute inline-flex h-full w-full animate-ping rounded-full bg-red-400 opacity-75"></span>
                                        <span class="relative inline-flex h-3 w-3 rounded-full bg-red-400"></span>
                                    </span>

                                    <span v-else-if="camera.status_id == 3" class="absolute right-0 top-0 z-20 flex h-3 w-3">
                                        <span class="absolute inline-flex h-full w-full animate-ping rounded-full bg-yellow-400 opacity-75"></span>
                                        <span class="relative inline-flex h-3 w-3 rounded-full bg-yellow-400"></span>
                                    </span>

                                    <span v-else-if="camera.status_id == 4" class="absolute right-0 top-0 z-20 flex h-3 w-3">
                                        <span class="absolute inline-flex h-full w-full rounded-full bg-gray-400 opacity-75"></span>
                                        <span class="relative inline-flex h-3 w-3 rounded-full bg-gray-400"></span>
                                    </span>
                                </div>
            ...
            <div v-if="!receivers.length && !cameras.length" class="mb-3 flex w-full max-w-screen-xl transform cursor-pointer flex-col rounded-md bg-white bg-opacity-75 p-6 text-slate-800 transition duration-500 ease-in-out hover:-translate-y-1 hover:shadow-lg dark:bg-slate-700 dark:bg-opacity-25 dark:text-slate-300 lg:flex-row lg:p-4 mx-auto" style="background: rgba(0,0,0,0.2);">
