    ...
    <AppLayout :title="__('dashboard.transmitterpanel.info.routename')">
        ...
        <div v-if="device" class="py-2">
            ...
            <div class="mx-2 flex max-w-full flex-col" style="background: rgba(0, 0, 0, 0.2);">
                ...
                <div
                    class="flex w-full transform cursor-pointer flex-col rounded-md bg-opacity-75 p-6 transition duration-500 ease-in-out hover:-translate-y-1 hover:shadow-lg text-slate-300 lg:flex-row lg:p-4">
