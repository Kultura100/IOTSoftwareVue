<template>
<aside class="hidden lg:flex flex-col items-center bg-white text-gray-700 shadow h-full leftmenu">
		...
		<div v-if="$page.props.Uzytkownik"  class="mt-auto w-full">
			...
			<button aria-label="wylogowanie" type="submit" v-on:click="Logout()"
